...
const SONGS = [
  ...
  },
  {
    ...
    youtubeId: "JVrsDRiGYbs", // CUSTOMIZE: add the correct YouTube ID
    startAt: 17,
  },
  {
    id: 4,
    ...
    vibe: "Changing the destiny...",
    youtubeId: "TbjbZFqLEtw",
    startAt: 243,
  },
  {
    id: 5,
    ...
    vibe: "when my heart finds yours..",
    youtubeId: "XqeEeTe0ROI",
    startAt: 9,
  },
  {
    id: 6,
    ...
    artist: "Arijit Singh",
    vibe: "What my heart sings for you",
    youtubeId: "Zkqhiil2kSo",
    startAt: 28,
  },
];
